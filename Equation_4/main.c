...
int main(void) {
    ...
    const double Tshow = 2.0 / f1; // 2 periods -> 0.4s for f1=5Hz
    ...
    // ---------------- Summary ----------------
    printf("----- Summary -----\n");
    printf("Eq4: x(t)=A1*cos(2*pi*f1*t)\n");
    printf("A1=%.3f, f1=%.3f Hz\n", A1, f1);
